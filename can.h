...
//#define CAN_MSG_OBJ_LEN			16		// C compiler uses shift operation << 4 as simple and fast4
...
#define CAN_TRANSMIT_BUF_MSG_CNT	20		// 201 * 7 = 1407 (UIP v3.0: max 1406)
#define CAN_RECEIVE_BUF_MSG_CNT		20
#else
...
extern boolean can_bus_off_state_detectedB;
