...
extern boolean to_enable_can_transparent_modeB;
extern boolean (*enable_can_transparent_mode_func)(void);

// Muzzle_ModeB==TRUE: No CAN bus transmission by A21 firmware if service is going on.
extern boolean Muzzle_ModeB;

extern boolean to_update_can_sensor_commu_idx_and_stepB;
extern boolean to_delay_can_sensor_commuB;
extern boolean to_continue_can_sensor_commuB;
...
void send_can_irma_msg_set(byte*, boolean, byte, byte, byte, can_addr_id_type);
